    ...
    <footer className="bg-secondary py-8 mt-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-playfair mb-4">L&apos;Artiste</h3>
            <p className="text-muted-foreground text-sm">
              Exploration artistique à travers la peinture, le collage, le stylo et le modelage.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/oeuvres" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Mes Œuvres
                </Link>
              </li>
              <li>
                <Link href="/coordonnees" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Coordonnées
                </Link>
              </li>
            </ul>
